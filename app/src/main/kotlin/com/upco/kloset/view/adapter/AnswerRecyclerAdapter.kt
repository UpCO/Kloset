 ...
 */
class AnswerRecyclerAdapter(val answers: ArrayList<Comment>, val context: Context): RecyclerView.Adapter<AnswerRecyclerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder?, position: Int) {
        holder?.setupUI(answers[position])
    }
    ...
    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        fun setupUI(answer: Comment) {
            tv_username.text = "Usuário"
            tv_content.text = answer.content
